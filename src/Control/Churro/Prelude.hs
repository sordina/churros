...
-- 1
-- 1
sources :: Transport t => [Source a t o] -> Source a t o
...
-- 1
-- 2
processN :: Transport t => (a -> IO [b]) -> Churro a t a b
processN f =
    buildChurro \i o -> do
...
-- 1
-- 3
justs :: Transport t => Churro a t (Maybe a) a
...
-- 1
-- 3
lefts :: Transport t => Churro a t (Either a b) a
...
-- 2
rights :: Transport t => Churro a t (Either a b) b
...
takeC :: (Transport t, Integral n) => n -> Churro a t a a
...
-- 3
-- 4
dropC :: (Transport t, Integral n) => n -> Churro a t a a
...
-- 4
-- 5
filterC :: Transport t => (a -> Bool) -> Churro a t a a
...
-- 9
-- 90
mapN :: Transport t => (a -> [b]) -> Churro a t a b
...
-- (1,2)
-- (2,3)
withPrevious :: Transport t => Churro a t a (a,a)
...
-- 2
-- 
processRetry :: Transport t => Natural -> (i -> IO o) -> Churro a t i o
...
--   
processRetry' :: (Exception e, Transport t) => Natural -> (i -> IO o) -> Churro a t i (Either e o)
...
--   
processRetry'' :: (Transport t, Exception e, Ord n, Enum n) => n -> (a -> IO b) -> Churro a t (n, a) (Either e b)
